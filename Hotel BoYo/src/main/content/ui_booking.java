...
public class ui_booking extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) throws SQLException, ClassNotFoundException {
        ...
        String q = "UPDATE usertable SET roomcost = '" + String.valueOf(sum) +
                "', roomtype = '" + roomType +
                "', roomno = '" + roomID +
                "', NumGuest = '" + numGuest +
                "', hallcost = '" + hall + "'" +
        ...
        this.dispose();
        JOptionPane.showMessageDialog(new JFrame(), "room booked successfully", "Alert",JOptionPane.PLAIN_MESSAGE);
